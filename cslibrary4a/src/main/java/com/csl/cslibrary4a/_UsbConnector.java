...
public class _UsbConnector {
    final boolean DEBUG = false;

    _CsReaderConnector csReaderConnector;
    ...
    _UsbConnector(_CsReaderConnector csReaderConnector, Context context, TextView textView, int productId, int vendorId, Utility utility) {
        ...
        public void run() {
            ...
            if (usbManager != null) {
                ...
                for (UsbDevice device : usbDeviceHashMap.values()) {
                    ...
                    ScanData scanResultA = new ScanData(null, 0, null);
    ...
    public boolean usbConnectionState = false;
