...
public class _SettingData {
    final boolean DEBUG_FILE = true;

    public int channel = -1;
    int antennaPower = -1;
    Context context; Utility utility; NotificationConnector notificationConnector; RfidReader rfidReader; _CsReaderConnector csReaderConnector;
    //CsReaderConnector csReaderConnector;

    public _SettingData(Context context, Utility utility, _CsReaderConnector csReaderConnector) {
    ...
    public boolean loadSettingFile(String stringMacAddress, String strlibraryVersion, boolean bChannelHoppingStatus, int iCurrentProfile) {
        boolean DEBUG = true;
        ...
        if (fileSetting.exists()) {
            ...
            if (instream != null) {
                ...
                preFilterData = new _SettingData.PreFilterData();
                while(true) {
                    line = null;
                    try {
