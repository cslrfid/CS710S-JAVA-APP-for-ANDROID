...
public class _DeviceFinder {
    _CsReaderConnector csReaderConnector;
    Utility utility;
    ScanData scanResultA = null;

    public _DeviceFinder(_CsReaderConnector csReaderConnector, Utility utility) {
...
//                    appendToLog("DeviceFinder.runnable: done udpSocket.setBoardcast");
                ...
                if (true) {
                    ...
                    if (readerSetting != null) {
                        ScanData scanResultA = new ScanData(null, 0, readerSetting.rxbuffer1);
    ...
    public boolean deviceFinderConnectState = false;
