...
public class _RfidReaderChipR2000 {
    ...
    Context context; Utility utility; _CsReaderConnector csReaderConnector;
    int powerLevelMax = 320;
    public _RfidReaderChipR2000(Context context, Utility utility, _CsReaderConnector csReaderConnector) {
